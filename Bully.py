class Bully: 
    """
    name:           Servername 
    node_id:        unique node id (random according to the time node ist started)
    port:           Server port
    coordinator:    it says if that specific node is the coordinator of the cluster or not.
